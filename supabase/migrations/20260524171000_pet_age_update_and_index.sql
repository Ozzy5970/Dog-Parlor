-- Create lower name lookup index and update pet age COALESCE hierarchy in submit functions
...
BEGIN
    ...
    BEGIN
        ...
        IF v_pet_id IS NOT NULL THEN
            -- Update missing pet fields only if safe (Note: age_years updates if a valid new age is provided)
            UPDATE pets
            SET
